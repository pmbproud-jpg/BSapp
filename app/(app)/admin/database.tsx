...
const TABLE_META: Record<string, TableMeta> = {
  ...
  daily_reports: {
    ...
    columns: [
      { key: "id", label: "ID", type: "uuid", readonly: true },
      { key: "project_id", label: "Projekt", type: "uuid" },
      { key: "report_date", label: "Data raportu", type: "date" },
      { key: "worker_count", label: "Liczba pracowników", type: "number" },
      { key: "worker_details", label: "Szczegóły personelu", type: "text" },
      { key: "weather", label: "Pogoda", type: "text" },
      { key: "temperature", label: "Temperatura", type: "text" },
      { key: "work_start", label: "Początek pracy", type: "text" },
      { key: "work_end", label: "Koniec pracy", type: "text" },
      { key: "work_description", label: "Opis prac", type: "text" },
      { key: "had_disruptions", label: "Zakłócenia", type: "boolean" },
      { key: "disruption_description", label: "Opis zakłóceń", type: "text" },
      { key: "had_orders", label: "Polecenia BL", type: "boolean" },
      { key: "order_description", label: "Opis poleceń", type: "text" },
      { key: "had_hourly_work", label: "Prace godzinowe", type: "boolean" },
      { key: "hourly_work_description", label: "Opis prac godz.", type: "text" },
      { key: "hourly_work_hours", label: "Godziny", type: "number" },
      { key: "notes", label: "Uwagi", type: "text" },
      { key: "status", label: "Status", type: "enum", enumValues: ["draft", "submitted", "approved"] },
      { key: "created_by", label: "Twórca", type: "uuid", readonly: true },
      { key: "approved_by", label: "Zatwierdzony przez", type: "uuid" },
      { key: "approved_at", label: "Data zatwierdzenia", type: "datetime" },
      { key: "created_at", label: "Utworzono", type: "datetime", readonly: true },
      { key: "updated_at", label: "Zaktualizowano", type: "datetime", readonly: true },
    ],
  },
  project_checklists: {
    label: "Checklista dokumentów",
    icon: "checkbox",
    color: "#10b981",
    columns: [
      { key: "id", label: "ID", type: "uuid", readonly: true },
      { key: "project_id", label: "Projekt", type: "uuid" },
      { key: "has_calculations", label: "Obliczenia", type: "boolean" },
      { key: "has_fire_protection", label: "Ppoż.", type: "boolean" },
      { key: "has_floor_plans", label: "Rzuty", type: "boolean" },
      { key: "has_sections", label: "Przekroje", type: "boolean" },
      { key: "has_schematics", label: "Schematy", type: "boolean" },
      { key: "has_calculations_match", label: "Obliczenia↔Plan", type: "boolean" },
      { key: "has_afu", label: "AFU", type: "boolean" },
      { key: "has_material_list", label: "Lista materiałów", type: "boolean" },
      { key: "has_montage_plan", label: "Plan montażu", type: "boolean" },
      { key: "has_operating_manuals", label: "Instrukcje", type: "boolean" },
      { key: "has_revision_docs", label: "Dok. powykonawcza", type: "boolean" },
      { key: "has_acceptance_protocol", label: "Protokół odbioru", type: "boolean" },
      { key: "has_collisions", label: "Kolizje", type: "boolean" },
      { key: "collision_notes", label: "Uwagi kolizje", type: "text" },
      { key: "shitlist_notes", label: "Shitlist", type: "text" },
      { key: "notes", label: "Uwagi", type: "text" },
      { key: "updated_by", label: "Zaktualizował", type: "uuid" },
      { key: "created_at", label: "Utworzono", type: "datetime", readonly: true },
      { key: "updated_at", label: "Zaktualizowano", type: "datetime", readonly: true },
    ],
  },
  project_obstructions: {
    label: "Przeszkody i zastrzeżenia",
    icon: "warning",
    color: "#ef4444",
    columns: [
      { key: "id", label: "ID", type: "uuid", readonly: true },
      { key: "project_id", label: "Projekt", type: "uuid" },
      { key: "type", label: "Typ", type: "enum", enumValues: ["behinderung", "bedenken"] },
      { key: "status", label: "Status", type: "enum", enumValues: ["active", "resolved", "escalated"] },
      { key: "title", label: "Tytuł", type: "text" },
      { key: "description", label: "Opis", type: "text" },
      { key: "cause", label: "Przyczyna", type: "text" },
      { key: "consequences", label: "Konsekwencje", type: "text" },
      { key: "cost_estimate", label: "Szacowany koszt", type: "number" },
      { key: "reported_at", label: "Zgłoszono", type: "datetime" },
      { key: "resolved_at", label: "Rozwiązano", type: "datetime" },
      { key: "reported_by", label: "Zgłosił", type: "uuid" },
      { key: "resolved_by", label: "Rozwiązał", type: "uuid" },
      { key: "notes", label: "Uwagi", type: "text" },
      { key: "created_at", label: "Utworzono", type: "datetime", readonly: true },
      { key: "updated_at", label: "Zaktualizowano", type: "datetime", readonly: true },
    ],
  ...
  project_deadlines: {
    ...
    columns: [
      ...
      { key: "deadline_date", label: "Termin", type: "date" },
      { key: "warning_days", label: "Ostrzeżenie (dni)", type: "number" },
      { key: "status", label: "Status", type: "enum", enumValues: ["pending", "warned", "overdue", "completed"] },
      { key: "completed_at", label: "Zakończono", type: "datetime" },
      { key: "related_obstruction_id", label: "Powiązana przeszkoda", type: "uuid" },
      { key: "created_by", label: "Twórca", type: "uuid", readonly: true },
      { key: "created_at", label: "Utworzono", type: "datetime", readonly: true },
      { key: "updated_at", label: "Zaktualizowano", type: "datetime", readonly: true },
    ],
